export const translations = {
  en: {
    ...
    'login.resetHint': 'Open the email from cveey and follow the link to choose a new password. If you did not receive it, check your spam folder.',
  ...
  tr: {
    ...
    'login.resetHint': 'cveey\'den gelen e-postayı aç ve yeni şifre belirlemek için bağlantıyı takip et. Görmediysen spam klasörünü kontrol et.',
